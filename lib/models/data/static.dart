...
List<Cell> cells = [
  const Cell(
      ...
      name: 'أنا',
      category: 'pronoun',
      image: 'assets/images/data/home/i.png',
      type: 'cell'),
  const Cell(
      id: 2,
      serial: 2,
      name: 'أريد',
      category: 'verb',
      image: 'assets/images/data/home/want.png',
      type: 'cell'),
  const Cell(
      id: 3,
      serial: 3,
      ...
      image: 'assets/images/data/home/what.png',
      type: 'cell'),
  const Cell(
      id: 4,
      serial: 4,
      name: 'لا',
      category: 'word',
      image: 'assets/images/data/home/no.png',
      type: 'cell'),
  const Cell(
      id: 5,
      serial: 5,
  ...
  const Cell(
      ...
      name: 'أنت',
      category: 'pronoun',
      image: 'assets/images/data/home/you.png',
      type: 'cell'),
  const Cell(
      id: 7,
      serial: 7,
      name: 'أذهب',
      category: 'verb',
      image: 'assets/images/data/home/go.png',
      type: 'cell'),
  const Cell(
      id: 8,
      serial: 8,
      name: 'أفعل',
      category: 'verb',
      image: 'assets/images/data/home/do.png',
      type: 'cell'),
  const Cell(
      id: 9,
      serial: 9,
      ...
      image: 'assets/images/data/home/to.png',
      type: 'cell'),
  const Cell(
      id: 10,
      serial: 10,
  ...
  const Cell(
      ...
      name: 'نحن',
      category: 'pronoun',
      image: 'assets/images/data/home/we.png',
      type: 'cell'),
  const Cell(
      id: 12,
      serial: 12,
      name: 'أأكل',
      category: 'verb',
      image: 'assets/images/data/home/eat.png',
      type: 'cell'),
  const Cell(
      id: 13,
      serial: 13,
      name: 'ألعب',
      category: 'verb',
      image: 'assets/images/data/home/play.png',
      type: 'cell'),
  const Cell(
      id: 14,
      serial: 14,
      name: 'على',
      category: 'preposition',
      image: 'assets/images/data/home/on.png',
      type: 'cell'),
  const Cell(
      id: 15,
      serial: 15,
      name: 'في',
      category: 'preposition',
      image: 'assets/images/data/home/in.png',
      type: 'cell'),
  const Cell(
      id: 16,
      serial: 16,
      name: 'أشرب',
      category: 'verb',
      image: 'assets/images/data/home/drink.png',
      type: 'cell'),
  const Cell(
      id: 17,
      serial: 17,
      name: 'أرى',
      category: 'verb',
      image: 'assets/images/data/home/see.png',
      type: 'cell'),
  const Cell(
      id: 18,
      serial: 18,
      name: 'أضع',
      category: 'verb',
      image: 'assets/images/data/home/put.png',
      type: 'cell'),
  const Cell(
      id: 19,
      serial: 19,
  ...
  const Cell(
      ...
      name: 'جيد',
      category: 'adjective',
      image: 'assets/images/data/home/good.png',
      type: 'cell'),
  const Cell(
      id: 21,
      serial: 21,
      name: 'أشخاص',
      category: 'people',
      image: 'assets/images/data/home/people.png',
      type: 'folder'),
  const Cell(
      id: 22,
      serial: 22,
      name: 'أشياء',
      category: 'folder',
      image: 'assets/images/data/home/things.png',
      type: 'folder'),
  const Cell(
      id: 23,
      serial: 23,
      name: 'غذاء',
      category: 'folder',
      image: 'assets/images/data/home/food.png',
      type: 'folder'),
  const Cell(
      id: 24,
      serial: 24,
      name: 'أماكن',
      category: 'folder',
      image: 'assets/images/data/home/places.png',
      type: 'folder'),
  const Cell(
      id: 25,
      serial: 25,
      name: 'محادثة',
      category: 'folder',
      image: 'assets/images/data/home/chat.png',
      type: 'folder'),
  const Cell(
      id: 26,
      serial: 26,
      name: 'أفعال',
      category: 'folder',
      image: 'assets/images/data/home/actions.png',
      type: 'folder'),
  const Cell(
      id: 27,
      serial: 27,
      name: 'أسئلة',
      category: 'folder',
      image: 'assets/images/data/home/questions.png',
      type: 'folder'),
  const Cell(
      id: 28,
      serial: 28,
      name: 'مشاعر',
      category: 'folder',
      image: 'assets/images/data/home/feelings.png',
      type: 'folder'),
  const Cell(
      id: 29,
      serial: 29,
